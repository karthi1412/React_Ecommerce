...
function Home() {
    return (
        ...
        <div >
                                                ...
                                                <div class="col-lg-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                                                    <div class="hero-text">
                                                        ...
                                                        <div class="hero-stats">
                                                            <div class="stat-item">
                                                                <span class="number purecounter" data-purecounter-start="0" data-purecounter-end="50000" data-purecounter-duration="0">50000</span>
                                                                <span class="label">Students Enrolled</span>
                                                            </div>
                                                            <div class="stat-item">
                                                                <span class="number purecounter" data-purecounter-start="0" data-purecounter-end="1200" data-purecounter-duration="0">1200</span>
                                                                <span class="label">Expert Courses</span>
                                                            </div>
                                                            <div class="stat-item">
                                                                <span class="number purecounter" data-purecounter-start="0" data-purecounter-end="98" data-purecounter-duration="0">98</span>
                                                ...
                                                <div class="col-lg-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                                                    <div class="hero-image">
                                                        <div class="main-image">
                                                            <img src={bannerone} alt="Online Learning" class="img-fluid" />
                                                        </div>

                                                        <div class="floating-cards">
                                                            <div class="course-card aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                                                                <div class="card-icon">
                                                            ...
                                                            <div class="course-card aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                                                                <div class="card-icon">
                                                            ...
                                                            <div class="course-card aos-init aos-animate" data-aos="fade-up" data-aos-delay="500">
                                                                <div class="card-icon">
            ...
            <section id="featured-courses" class="featured-courses section section-two">
                ...
                <div class="container aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                            <div class="course-card">
                                <div class="course-image">
                                    <img src={studentsnine} alt="Course" class="img-fluid" />
                        ...
                        <div class="col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                            <div class="course-card">
                                <div class="course-image">
                                    <img src={campusfour} alt="Course" class="img-fluid" />
                        ...
                        <div class="col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                            <div class="course-card">
                                <div class="course-image">
                                    <img src={studentsseven} alt="Course" class="img-fluid" />
                        ...
                        <div class="col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                            <div class="course-card">
                                <div class="course-image">
                                    <img src={educationfive} alt="Course" class="img-fluid" />
                        ...
                        <div class="col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                            <div class="course-card">
                                <div class="course-image">
                                    <img src={activitythree} alt="Course" class="img-fluid" />
                                    <div class="badge certificate">Certificate</div>
                        ...
                        <div class="col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                            <div class="course-card">
                                <div class="course-image">
                                    <img src={teachersix} alt="Course" class="img-fluid" />
                                    <div class="badge new">New</div>
